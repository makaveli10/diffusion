...
3. [photorealistic.ipynb]() - This model generates photorealistic images. Even with a very simple prompt it can generate realistic images and with a detailed prompt it is even better. Some results from the model:
<figure>
<p align="center">
...
4. [lowra_lowKey.ipynb]() - This model generates ```low key``` images. Generates character where they have their own style in terms of lighting and overall atmosphere. It is an amazing model to generate low light images. A few interesting samples from the model:
<figure>
<p align="center">
...
5. [battleCars.ipynb]() - This model can turn any vehicle into a battle car. Its a lot fun to actually play with it. It creates the battle vehicles with abstract environment. Some battle cars generated by the model:
<figure>
<p align="center">
